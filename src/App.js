  ...
  return (
    <Routes>
      <Route path="/" element={<AppLayout />}>
        ...
        <Route
          path="pratapB/client-side-pagination"
          element={<PBClientSidePagination />}
        />
        <Route
          path="pratapB/meeting-selector"
          element={<PBMeetingSelector />}
        />

        <Route
          path="payalC/server-side-pagination"
          element={<PCServerSidePagination />}
        />
        <Route path="payalC/meeting-selector" element={<PCMeetingSelector />} />

        <Route
          path="hetV/server-side-pagination"
          element={<HVServerPagination />}
        />
        <Route path="hetV/meeting-selector" element={<HVMeetingSelector />} />

        <Route
          path="sagarB/client-side-pagination"
          element={<SBClientSidePagination />}
        />
        <Route path="sagarB/meeting-selector" element={<SBMeetingSelector />} />

        <Route
          path="sagarM/client-side-pagination"
          element={<SMClientSidePagination />}
        />
